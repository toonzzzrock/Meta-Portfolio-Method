...
def stats_uni_corr(ret):
    ...
    note that the ones diagonal is a line of symmetry, the upper and lower and triangles have the same values
    Parameters
    ----------
    ret : dataframe
    ...
    -------
    dictionary
        contains correlation matrix,  mean of upper triangle elems, std of upper triangle elems
    '''
    ...
    return {'Correlation Matrix':corr,
            ...
            'Standard Deviation of Correlations':values.std(ddof=1)}